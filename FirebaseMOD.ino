...
void loop() {
  ...
  ircar1o = digitalRead(IRcar1);
  ircar2o = digitalRead(IRcar2);
  ircar3o = digitalRead(IRcar3);
  //lcd.begin();
  //lcd.print("000");
...
if(ircar1o == 0 || bcar1 == 0)
  {
    Firebase.setInt(firebaseData, "/Slot 1 :", 1);
    ...
    Firebase.setInt(firebaseData, "/Slot 1 :", 0);
    slot1 = 0;
    }

 if(ircar2o == 0 || bcar2 == 0)
  {
    Firebase.setInt(firebaseData, "/Slot 2 :", 1);
  ...
  Firebase.setInt(firebaseData, "/Slot 2 :", 0);
  slot2 =0;
  }
 
  if(ircar3o == 0 || bcar3 == 0)
  {
    Firebase.setInt(firebaseData, "/Slot 3 :", 1);
    ...
    Firebase.setInt(firebaseData, "/Slot 3 :", 0);
    slot3 = 0;
  }
  ...
  if(Firebase.setInt(firebaseData, "/Available Parking Slots :", ava))
  {
   ...
   if(Firebase.get(firebaseData, "/Slot 1 :"))
  {
      Serial.print("data = ");
      Serial.println(firebaseData.intData());
      ircar1 = firebaseData.intData();
      if(ircar1 == 1){
        ircar1 = 0;
        }
       else{
     ...
     if(Firebase.get(firebaseData, "/Slot 2 :"))
  {
      Serial.print("data = ");
      Serial.println(firebaseData.intData());
      ircar2 = firebaseData.intData();
       if(ircar2 == 1){
        ircar2 = 0;
        }
       else{
     ...
     if(Firebase.get(firebaseData, "/Slot 3 :"))
  {
      Serial.print("data = ");
      Serial.println(firebaseData.intData());
      ircar3 = firebaseData.intData();
       if(ircar3 == 1){
        ircar3 = 0;
        }
        else{
